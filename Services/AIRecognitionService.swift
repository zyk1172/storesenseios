...
final class AIRecognitionService {
    ...
    3. 如果非常整齐/整齐：用绿色字体，如"哇哦！这整齐度简直可以上杂志封面了！"、"这收纳水平，强迫症看了都直呼内行~"
    4. 如果一般：用黄色或橙色字体，如"乱中有序的居家烟火气，挺好挺好！"、"这是传说中的'薛定谔的整齐'吗？"
    5. 如果稍显杂乱/非常杂乱：用红色字体，但要温柔幽默，如"这是一种不羁的艺术风格，我懂的~"、"东西们正在开派对，要不要让它们回回神？"、"看出来你最近很忙啦，找个周末稍微给它们排个队吧~"
    6. 直接写评价，不要加引号或标题
    """
